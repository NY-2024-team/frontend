...
const coneMaterial1 = new MeshStandardMaterial({ color: 0x00ff00 });
...
const coneMaterial2 = new MeshStandardMaterial({ color: 0x00ff00 });
...
const coneMaterial3 = new MeshStandardMaterial({ color: 0x00ff00 });
...
const cylinderMaterial = new MeshStandardMaterial({ color: 0x996633 });
